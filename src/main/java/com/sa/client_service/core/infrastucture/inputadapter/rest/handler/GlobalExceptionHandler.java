package com.sa.client_service.core.infrastucture.inputadapter.rest.handler;
...
public class GlobalExceptionHandler {
    ...
    @ResponseStatus(value = HttpStatus.CONFLICT)
    public RestApiErrorDTO handleInvalidParameterException(InvalidParameterException ex) {
        return new RestApiErrorDTO(List.of(ex.getMessage()));
    }
    ...
    public RestApiErrorDTO handleRuntimeException(RuntimeException ex) {
        return new RestApiErrorDTO(List.of(ex.getMessage()));
    }
}
